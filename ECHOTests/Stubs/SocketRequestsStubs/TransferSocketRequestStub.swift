...
struct TransferAccountsSocketRequestElementStub: SocketRequestStub {
...
struct TransferRequredFeeSocketRequestElementStub: SocketRequestStub {
...
struct TransferChainIdSocketRequestElementStub: SocketRequestStub {
...
struct TransferGlobalPropertiesSocketRequestElementStub: SocketRequestStub {
...
struct TransferResultSocketRequestElementStub: SocketRequestStub {
...
struct TransferSocketRequestStubHodler: SocketRequestStubHodler {
    ...
    var requests: [SocketRequestStub] = [TransferResultSocketRequestElementStub(),
                                         TransferGlobalPropertiesSocketRequestElementStub(),
                                         TransferChainIdSocketRequestElementStub(),
                                         TransferRequredFeeSocketRequestElementStub(),
                                         TransferAccountsSocketRequestElementStub()]
}
